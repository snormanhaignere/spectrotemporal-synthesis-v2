...
P.thirdlayer_temp_mod_rates = [8, 0.5,1,2,4,8,16];
P.thirdlayer_temp_mod_lowpass = [1, zeros(1,6)];
...
P.spec_mod_rates = [4, 0.25,0.5,1,2,4,8];
P.spec_mod_lowpass = [1, zeros(1,6)];

% spectral modulation rates of third layer
% and whether the filters are lowpass or bandpass (the default)
P.thirdlayer_spec_mod_rates = [4, 0.25,0.5,1];
P.thirdlayer_spec_mod_lowpass = [1, zeros(1,3)];
